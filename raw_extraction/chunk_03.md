...
- topic of instructions, from routine prohibitions on simple notices and simple directions to detailed condi-
...
- manner of formulation: from presenting an idea in simple terms to highlighting significant points appro-
...
- use of language: from basic vocabulary and simple sentences to an assured, personal, natural style appro-
...
- content: from familiar subjects of interest and routine factual information to complex academic and pro-

fessional topics, distinguishing one’s own viewpoints from those in the sources;

- types of text: from short reports and posters to complex texts that present a case, or provide critical ap-
