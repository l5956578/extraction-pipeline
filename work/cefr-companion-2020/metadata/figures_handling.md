...
**Figures 6–7** are radar profiles. PNG is canonical; structured levels for future UI live in `work/metadata/figure_06_profile_data.json` (and figure_07 when verified).
