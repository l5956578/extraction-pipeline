...
<!-- el:start type=prose id=prose_p010 page=1 -->
...
<!-- table-continuity: full multipage Table 2 lives on document page 26
     db:id=cefr2001_table_2_self_assessment_grid; half-grid removed to prevent duplicate data (RIE-010) -->
...
<!-- table-continuity: full multipage Table 3 lives on document page 28
     db:id=cefr2001_table_3_qualitative_spoken_language; no half-grid (RIE-010) -->
...
![Figure 2 — Common Reference Levels nine-level branching](assets/figures/figure_02_nine_level_branching.png)
...
<!-- el:end id=cefr2001_table_4_a2_plus_listening -->
...
![Figure 3 — Basic User branching example](assets/figures/figure_03_basic_user_branching_example.png)

<!-- el:end id=cefr2001_figure_03_basic_user_branching_example -->
...
<!-- table-continuity: full multipage Table 5 lives on document page 48
     db:id=cefr2001_table_5_external_context_of_use; right half merged into start page (RIE-010) -->
