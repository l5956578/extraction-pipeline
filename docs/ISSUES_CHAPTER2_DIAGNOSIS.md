...
| 2026-07-16 | **Pass 2:** `callout_detect.py` blue-fill detection; pure_text pages use callout+side RO (p.30–31); extract `callout_bbox`; gates V-ORDER-31 + blockquote lead; progressive-para dedupe (p.43); chunk_02 re-extract×2. Progress log: `work/metadata/CONTRACT_HARDENING_PROGRESS.md`. **Still open:** Phase 5 full book |
