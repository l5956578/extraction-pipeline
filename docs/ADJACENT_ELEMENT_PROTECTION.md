...
| **P4** | **Done** | `work/cefr-companion-2020/metadata/golden/page_{027,028,029,032,035,038,047}.json` with must_have / must_not_have / counts; wired into `adjacent_guard`. |
...
- `work/cefr-companion-2020/metadata/golden/*.json`
