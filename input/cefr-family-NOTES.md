...
| `CEFR Descriptors (2020).xlsx` | `cefr-descriptors-2020` | `tabular_db` (later) |
| `cefr-self-assessment-grid-cn.md` | `cefr-self-assessment-grid-cn` | `markdown_import` (pair with EN grid) |
